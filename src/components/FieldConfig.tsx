...
//   fieldId: string | null; // fieldId can be null if dialog is closed
//   onClose: () => void;
// }

// // Add onClose prop to the component
...
//     // Add a check to ensure fieldId is not null before dispatching
//     if (fieldId) {
...
//           />
//           <FormControlLabel
//             control={<Checkbox checked={fieldState.required} name="required" onChange={handleChange} />}
//             label="Required"
//           />
...
import {
  ...
  DialogTitle,
  DialogActions,
  Switch, // Imported Switch component
} from '@mui/material';
import { Delete as DeleteIcon, Add as AddIcon, Remove as RemoveIcon, Close as CloseIcon } from '@mui/icons-material';
import { Field, ValidationRule } from '../types/formTypes';
